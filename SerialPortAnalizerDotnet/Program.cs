...
internal class Program
{
    ...
    private static MessageSender messageSender = new MessageSender(5000, sensorsInfo);

    [STAThread]
    static void Main(string[] args)
    {
        // New monitoring thread
        Thread monitoringThread = new Thread(messageSender.StartMonitoring); 
